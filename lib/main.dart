...
class _SimpleCalState extends State<SimpleCal> {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Table(
                    children: [
                      TableRow(
                          children: [_buildBtn('/', 1, bgColor, bgColor2)]),
                      TableRow(
                          children: [_buildBtn('×', 1, bgColor, bgColor2)]),
                      TableRow(
                          children: [_buildBtn('-', 1, bgColor, bgColor2)]),
                      TableRow(
                          children: [_buildBtn('+', 1, bgColor, bgColor2)]),
                      TableRow(
                          children: [_buildBtn('=', 1, bgColor1, bgColor2)]),
                    ],
                  ),
                ),
              ],
  ...
  Widget _buildBtn(
      String btnText, double btnHeight, Color bntColor, Color btnCText) {
    return Container(
        ...
        child: FlatButton(
          ...
          child:
              Text(btnText, style: TextStyle(fontSize: 30.0, color: btnCText)),
  ...
  btnPres(String btnText) {
    setState(() {
      if (btnText == "C") {
        ...
        equation = (int.parse(equation) * -1).toString();
        if (equation == "") {
          equation = "0";
        }
      } else if (btnText == "=") {
